...
public:
    ...
    void hesapla(double* in, double* & out  ) ;



    MLP(int layerNum , int* layerSiz, int inputNum);
    ~MLP();
};

MLP::MLP(int layerNum , int* layerSiz, int inputNum )  { //buna girdi nöronları dahil değil
